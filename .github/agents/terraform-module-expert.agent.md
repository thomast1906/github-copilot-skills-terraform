...
4. **Don't force restructuring** - Make changes incrementally, prioritize working code
5. **Adapt to their patterns** - If they have a working structure, enhance it rather than replacing it
6. **Document deviations** - Explain why existing structure differs from recommendations
